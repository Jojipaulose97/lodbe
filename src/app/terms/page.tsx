            ...
            <div className="max-w-3xl mx-auto space-y-12">
                ...
                <div className="space-y-10">
                    ...
                    <section className="space-y-4">
                        <Typography variant="h3">1. Introduction & Governance</Typography>
                    ...
                    <section className="space-y-4">
                        <Typography variant="h3">2. Company Overview</Typography>
                        <Typography variant="p">
                    ...
                    <section className="space-y-4">
                        <Typography variant="h3">3. Eligibility & Accounts</Typography>
                        <Typography variant="p">
                    ...
                    <section className="space-y-4">
                        <Typography variant="h3">4. Acceptable Use</Typography>
                        <Typography variant="p">
                    ...
                    <section className="space-y-4">
                        <Typography variant="h3">5. Cloud Storage & Data Management</Typography>
                        <Typography variant="p">
                    ...
                    <section className="space-y-4">
                        <Typography variant="h3">6. Intellectual Property</Typography>
                        <Typography variant="p">
                    ...
                    <section className="space-y-4">
                        <Typography variant="h3">7. Payments & Billing</Typography>
                        <Typography variant="p">
                    ...
                    <section className="space-y-4">
                        <Typography variant="h3">8. Networking & Ecosystems</Typography>
                        <Typography variant="p">
                    ...
                    <section className="space-y-4">
                        <Typography variant="h3">9. Educational Content</Typography>
                        <Typography variant="p">
                    ...
                    <section className="space-y-4">
                        <Typography variant="h3">10. Limitation of Liability</Typography>
                        <Typography variant="p">
                    ...
                    <section className="space-y-4">
                        <Typography variant="h3">11. Governing Law & Jurisdiction</Typography>
                        <Typography variant="p">
